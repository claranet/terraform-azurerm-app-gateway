...
| public\_ip | Public IP parameters. | <pre>object({<br/>    enabled                 = optional(bool, true)<br/>    ddos_protection_mode    = optional(string, "VirtualNetworkInherited")<br/>    ddos_protection_plan_id = optional(string)<br/>    extra_tags              = optional(map(string), {})<br/>  })</pre> | `{}` | no |
